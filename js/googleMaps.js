...
let locations = [];
let temp = [];
const endpointLaikes =
  'https://raw.githubusercontent.com/DimitrisTzimikas/pameLaiki/master/json/laikes.json';
...
function clearSearchMarkers() {
  for (let i = 0; i < searchMarker.length; i++) searchMarker[i].setMap(null);
  searchMarker = [];
}
...
function initMap() {
  ...
  document
    ...
    .addEventListener('click', findNearestPlace);
}
